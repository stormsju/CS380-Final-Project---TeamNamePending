...
public class Log {
     ...
     */
    Log(Log log, Enum<Activity> activity, String personID){
        LocalDateTime now;
     ...
     * @param activity Activity type being processed.
     */
    Log(Log log, String ID, Enum<Activity> activity, String personID){
        LocalDateTime now;
        DateTimeFormatter dtf;
        Activity act = (Activity) activity;
        switch(act) {
     ...
     * @param activity Activity type being processed.
     */
    Log(Log log, String ID, String cID, Enum<Activity> activity, String personID){
        LocalDateTime now;
        DateTimeFormatter dtf;
        Activity act = (Activity) activity;
        switch(act) {
