...
public class PersonService {
    ...
    public String insertPerson(Person person){
        ...
        person.getLname() == null ||
        person.getUsername() == null ||
        person.getEmail() == null ||
        person.getPassword() == null ||
        person.getDate() == null)return "One or more fields for Person were null";
    ...
    /**
     * A finder method to retrieve a Person from database that matches provided email.
     * @param email Email to search database Person for.
     * @return A Person object with email if found. Else, null.
     */
